 ...
 * able to handle intents by implementing the abstract method {foolink #handleIntent(Intent)}.
 */
public abstract class AbstractGenesysActivity extends BaseActivity {
	...
	*/
	 ...
	 *
	 * fooparam intent Intent received when this activity is started or when running.
	 */
